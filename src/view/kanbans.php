...
$kanbans = $kanbanController->getMyKanbans();
...
foreach ($keySort as $k => $v) {
	if (isset($_GET[$v]) && !empty($_GET[$v])) {
		...
		$kanbans = $kanbanController->getMyKanbansOrdered($columnName, $order);
		break;
	}
}
		...
		<div class="container-fluid p-5">
			<div class="row justify-content-center">
				<div class="col-lg-8 col-md-12 col-sm-12 order-lg-first">
					<h2 class="h1 display-4 text-center">Mes modèles de Kanban</h2>
